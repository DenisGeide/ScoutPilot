...
def _print_status(config: AppConfig) -> None:
    ...
    print("Browser Engine, Semantic Observation Engine, Tool Runtime, LLM Provider Layer, Planning Engine, Hierarchical Memory, Autonomous Agent Runtime, Execution Intelligence и Context Budgeting подключены.")
