...
Это не готовый продукт для реальной эксплуатации. Репозиторий можно установить, проверить локальными тестами, посмотреть CLI в dry-run режиме и вручную запустить smoke-тест на HH.ru без hardcoded selectors и без автоматической отправки заявок.
